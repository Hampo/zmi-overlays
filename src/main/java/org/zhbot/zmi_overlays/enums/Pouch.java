...
public enum Pouch {
    SMALL(ItemID.RCU_POUCH_SMALL, -1, VarbitID.SMALL_ESSENCE_POUCH_TYPE, VarbitID.SMALL_ESSENCE_POUCH),
    MEDIUM(ItemID.RCU_POUCH_MEDIUM, ItemID.RCU_POUCH_MEDIUM_DEGRADE, VarbitID.MEDIUM_ESSENCE_POUCH_TYPE, VarbitID.MEDIUM_ESSENCE_POUCH),
    LARGE(ItemID.RCU_POUCH_LARGE, ItemID.RCU_POUCH_LARGE_DEGRADE, VarbitID.LARGE_ESSENCE_POUCH_TYPE, VarbitID.LARGE_ESSENCE_POUCH),
    GIANT(ItemID.RCU_POUCH_GIANT, ItemID.RCU_POUCH_GIANT_DEGRADE, VarbitID.GIANT_ESSENCE_POUCH_TYPE, VarbitID.GIANT_ESSENCE_POUCH),
    COLOSSAL(ItemID.RCU_POUCH_COLOSSAL, ItemID.RCU_POUCH_COLOSSAL_DEGRADE, VarbitID.COLOSSAL_ESSENCE_POUCH_TYPE, VarbitID.COLOSSAL_ESSENCE_POUCH);
    ...
    Pouch(int itemId, int degradedItemId, int typeVarbitId, int amountVarbitId)
    {
        this.itemId = itemId;
